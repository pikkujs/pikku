...
import type { WorkflowRun, WorkflowRunStatus } from '.bun/@pikku+core@0.12.106/node_modules/@pikku/core/dist/wirings/workflow/workflow.types'
import type { StreamWorkflowRunInput, GetScenarioArtifactInput } from '.bun/@pikku+addon-console@0.12.52+2ba48ff24cda2800/node_modules/@pikku/addon-console/dist/.pikku/addon/rpc/pikku-rpc-wirings-map.internal.gen'
import type { ListPackagesInput, SearchPackagesInput, GetPackageInput, GetPackageIconInput, ListOpenApisInput, GetOpenApiInput, GetPackageDownloadInput, RequestPublishUrlInput, PublishPackageInput, IngestPackageInput, StartMetaExtractionInput, StartOpenApiEnrichmentInput } from '../../../addon-registry/.pikku/addon/rpc/pikku-rpc-wirings-map.internal.gen.d.js'
import type { GetReviewQueueInput, GetReviewFixesInput, CastVerdictInput, ClearVerdictInput } from '../../../addon-review/.pikku/addon/rpc/pikku-rpc-wirings-map.internal.gen.d.js'
...
export type IngestStageChangeInputBody = IngestStageChangeInput & {}
export type ListStageChangesInputBody = ListStageChangesInput & {}
export type AnswerStageChangeInputBody = AnswerStageChangeInput & {}
export type UploadStageShotInputBody = UploadStageShotInput & {}
...
export type StartMetaExtractionInputBody = StartMetaExtractionInput & {}
export type StartOpenApiEnrichmentInputBody = StartOpenApiEnrichmentInput & {}
export type GetReviewQueueInputBody = GetReviewQueueInput & {}
export type GetReviewFixesInputBody = GetReviewFixesInput & {}
export type CastVerdictInputBody = CastVerdictInput & {}
export type ClearVerdictInputBody = ClearVerdictInput & {}
export type CreateReviewFixTicketInputBody = CreateReviewFixTicketInput & {}
export type GetScenarioRunArtifactInputParams = Pick<GetScenarioRunArtifactInput, 'stageId' | 'runId'> & {}
export type GetScenarioRunArtifactInputBody = Omit<GetScenarioRunArtifactInput, 'stageId' | 'runId'> & {}
...
export type HTTPWiringsMap = {
  ...
  readonly '/sandbox/:sandboxId/scenario-run/:runId/artifact': {
    readonly GET: HTTPWiringHandler<GetScenarioRunArtifactInput, null>,
  },
  readonly '/stage/:stageId/scenario-run/:runId/artifact': {
    readonly GET: HTTPWiringHandler<GetScenarioRunArtifactInput, null>,
  },
  ...
  readonly '/rpc/agent/:agentName/approve': {
    readonly POST: HTTPWiringHandler<AgentApproveCallerInput, AgentApproveCallerOutput>,
  },
  ...
  readonly '/platform/changes/file': {
    readonly POST: HTTPWiringHandler<IngestStageChangeInput, IngestStageChangeOutput>,
  },
  readonly '/platform/changes/list': {
    readonly POST: HTTPWiringHandler<ListStageChangesInput, ListStageChangesOutput>,
  },
  readonly '/platform/changes/answer': {
    readonly POST: HTTPWiringHandler<AnswerStageChangeInput, AnswerStageChangeOutput>,
  },
  readonly '/platform/changes/shot': {
    readonly POST: HTTPWiringHandler<UploadStageShotInput, UploadStageShotOutput>,
  },
  ...
  readonly '/review/queue': {
    readonly POST: HTTPWiringHandler<FlattenedRPCMap['review:getReviewQueue']['input'], FlattenedRPCMap['review:getReviewQueue']['output']>,
  },
  readonly '/review/fixes': {
    readonly POST: HTTPWiringHandler<FlattenedRPCMap['review:getReviewFixes']['input'], FlattenedRPCMap['review:getReviewFixes']['output']>,
  },
  readonly '/review/verdict': {
    readonly POST: HTTPWiringHandler<FlattenedRPCMap['review:castVerdict']['input'], FlattenedRPCMap['review:castVerdict']['output']>,
  },
  readonly '/review/verdict/clear': {
    readonly POST: HTTPWiringHandler<FlattenedRPCMap['review:clearVerdict']['input'], FlattenedRPCMap['review:clearVerdict']['output']>,
  },
  readonly '/review/fixes/ticket': {
    readonly POST: HTTPWiringHandler<CreateReviewFixTicketInput, CreateReviewFixTicketOutput>,
  },
