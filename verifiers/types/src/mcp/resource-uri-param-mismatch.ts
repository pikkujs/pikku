...
wireMCPResource({
  ...
  title: 'User Resource',
  description: 'Get user by ID',
  func: pikkuMCPResourceFunc<unknown>(async ({}, _data, { mcp }) => {
...
wireMCPResource({
  ...
  title: 'User Resource',
  description: 'Get user by ID',
  func: pikkuMCPResourceFunc<{ id: string }>(async ({}, { id }, { mcp }) => {
...
wireMCPResource({
  ...
  func: pikkuMCPResourceFunc<unknown>(async (_, _data, { mcp }) => {
