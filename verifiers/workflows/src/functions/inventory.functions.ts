...
>(async ({ logger }, data) => {
  ...
  return {
    lowStockItems: [
      { productId: 'prod-5', productName: 'Widget A', available: 5, threshold },
      { productId: 'prod-8', productName: 'Gadget B', available: 3, threshold },
      { productId: 'prod-12', productName: 'Tool C', available: 8, threshold },
    ],
  }
})
