...
- 80eb5c0: Add the passphrase gate for classified columns: `DataLock`, the `requireUnlocked` middleware, and `wireDataLock` on a new `@pikku/core/data-lock` entry point.
