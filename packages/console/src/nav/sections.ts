      ...
      groups: [
        {
          ...
          items: [
            item(m.nav_http(), '/http', Globe),
            item(m.nav_channels(), '/channels', Radio),
            item(m.nav_mcp(), '/mcp', Cpu),
            item(m.nav_cli(), '/cli', Terminal),
            item(m.nav_gateways(), '/gateways', Network),
          ],
        },
        {
          id: 'async',
          ...
          items: [
            item(m.nav_schedulers(), '/schedulers', Clock),
            item(m.nav_queues(), '/queues', ListOrdered),
            item(m.nav_triggers(), '/triggers', Zap),
          ],
        },
        {
          id: 'runs',
