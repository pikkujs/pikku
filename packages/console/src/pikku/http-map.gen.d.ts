...
export type HttpOptionsApiWorkflowRunRunIdStreamInputParams = Pick<HttpOptionsApiWorkflowRunRunIdStreamInput, 'runId'> & {}
export type HttpOptionsApiWorkflowRunRunIdStreamInputBody = Omit<HttpOptionsApiWorkflowRunRunIdStreamInput, 'runId'> & {}
...
export type HTTPWiringsMap = {
  readonly '/api/workflow-run/:runId/stream': {
    ...
    readonly OPTIONS: HTTPWiringHandler<HttpOptionsApiWorkflowRunRunIdStreamInput, unknown>,
  },
};
