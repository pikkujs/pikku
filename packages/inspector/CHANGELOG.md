...
- 52eb461: Prune a unit's addon wiring files alongside its addon declarations, so a
...
- d067ac9: Skip the schema-generator retention assertion under `--coverage`. Coverage
...
- 1becc2d: Publish an MCP tool under its declared `name`
...
- d64db40: Prune a filtered-out workflow's file entry, not just its meta.
...
- af2b764: **Breaking:** extend the classification sink scan to personal data, as PKU954.
