...
const createHarness = (
  ...
  const modelSawMessages: AIMessage[][] = []
  ...
  const storage = {
    ...
    saveMessages: async (threadId: string, newMessages: AIMessage[]) => {
  ...
  pikkuState(null, 'package', 'singletonServices', {
    ...
    aiStorage: storage,
    aiAgentRunner: {
      run: async (params: AIAgentRunnerParams) => {
