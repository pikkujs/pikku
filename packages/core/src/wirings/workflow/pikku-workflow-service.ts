...
export abstract class PikkuWorkflowService implements WorkflowService {
  ...
  constructor() {
    ...
    // Workflow HTTP routes (workflowStart:, workflow:, workflowStatus:) are now
    // auto-generated by the inspector post-process and wired by the codegen
    // pipeline via synthetic wireHTTP() calls in pikku-http-wirings.gen.ts.
  }
