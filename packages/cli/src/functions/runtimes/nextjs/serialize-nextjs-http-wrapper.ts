...
export const pikku = (options?: CorePikkuFetchOptions) => {
  ...
  const rpc = async <Name extends keyof FlattenedRPCMap>(
    ...
    return dynamicActionRequest('${globalHTTPPrefix}/rpc/:rpcName' as any, 'POST' as any, { rpcName, ...(data != null && typeof data === 'object' ? data : {}) }) as unknown as FlattenedRPCMap[Name]['output']
  }
  ...
  const staticRPC = async <Name extends keyof FlattenedRPCMap>(
    ...
    return staticActionRequest('${globalHTTPPrefix}/rpc/:rpcName' as any, 'POST' as any, { rpcName, ...(data != null && typeof data === 'object' ? data : {}) }) as unknown as FlattenedRPCMap[Name]['output']
  }
