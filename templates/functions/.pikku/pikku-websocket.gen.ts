...
export class PikkuWebSocket<
  Channel extends keyof ChannelsMap,
> extends CorePikkuWebsocket {
  /**
   * Send a message to a specific route and method.
   * Validates the input data type.
   */
  public getRoute<Route extends keyof ChannelsMap[Channel]['routes']>(
    route: Route
  ): PikkuWebSocketRoute<Channel, Route> {
