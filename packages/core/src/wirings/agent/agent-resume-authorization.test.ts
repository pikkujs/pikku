...
import { resumeAgentSync } from './agent-runner.js'
import { resumeAgent } from './agent-stream.js'
...
describe('resumeAgentSync authorization', () => {
...
describe('resumeAgent (streaming) authorization', () => {
  const channel = {
    send: async () => {},
    close: async () => {},
  } as any
