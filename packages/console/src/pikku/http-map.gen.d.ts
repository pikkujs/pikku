...
export type FlattenedRPCMapParams = Pick<FlattenedRPCMap, 'runId'> & {}
export type FlattenedRPCMapBody = Omit<FlattenedRPCMap, 'runId'> & {}
...
export type HTTPWiringsMap = {
  readonly '/workflow-run/:runId/stream': {
    readonly GET: HTTPWiringHandler<FlattenedRPCMap, FlattenedRPCMap>,
  },
