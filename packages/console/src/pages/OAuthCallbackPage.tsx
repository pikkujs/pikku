      ...
      .catch(async (err: any) => {
        ...
        if (err instanceof Response) {
          try {
            ...
            setErrorMessage(body?.message || body?.error || JSON.stringify(body));
          } catch {
      ...
      <Stack align="center" gap="lg">
        ...
        {status === "success" && (
          <>
            ...
            <Text size="lg" fw={600}>Authorization Successful</Text>
            <Text size="sm" c="dimmed" ta="center">
              You can close this window. The connection status will update automatically.
            </Text>
            <Button
              variant="light"
        ...
        {status === "error" && (
          <>
            <Alert icon={<AlertTriangle size={16} />} color="red" variant="light" w="100%">
              {errorMessage}
            </Alert>
            <Button
              variant="light"
