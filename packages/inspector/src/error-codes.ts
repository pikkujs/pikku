...
export enum ErrorCode {
  ...
  ADDON_MCP_FUNCTION_NOT_FOUND = 'PKU341',
  ADDON_EXPOSE_FUNCTION_NOT_FOUND = 'PKU343',
  ADDON_EXPOSE_NOT_STATIC = 'PKU344',
  ...
  DB_SECRET_COLUMN_STORED_PLAIN = 'PKU483',
  DB_FORM_ON_NON_STRING = 'PKU484',
  DB_DEFAULT_SCHEMA_NAME_COLLISION = 'PKU485',
  ...
  SINGLETON_SERVICES_TYPE_UNRESOLVED = 'PKU724',
