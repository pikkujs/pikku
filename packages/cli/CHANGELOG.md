...
- 819a61e: Add `pikku fabric changes file`, so an item decided outside the panel — in a call, a
  thread, a spec — reaches the same queue as one circled in a deployed stage. It carries the
  words only; the screenshot, the circled elements and the build stay the panel's to supply.
  `--body-file` takes the body from a file, because a real one has newlines in it.
...
- add56d2: `pikku dev` and `pikku serve` build an agent runner for one-shot AI calls, and it can do audio.
...
- add56d2: `pikku dev` and `pikku serve` now provide the scope and webhook services.
...
- Updated dependencies [add56d2]
  - @pikku/core@0.12.111
  - @pikku/inspector@0.12.81
  - @pikku/kysely@0.13.27
...
- 54138b1: Product analytics moves into core behind a `scaffold.analytics` generator.
...
- bb6abc2: The `--tsc` / `--tsc-summary` gate now runs the project's own `tsc` binary instead of loading its `typescript` module and driving the compiler API. TypeScript 7 ships a compiler binary but no importable API, so the old code crashed on any project that had upgraded; shelling out works the same on 5, 6 and 7.

  Full output is now a plain line per diagnostic rather than a colour-highlighted code frame.

- Updated dependencies [4c7a1b5]
- Updated dependencies [9d7a96d]
- Updated dependencies [bb6abc2]
  - @pikku/ai-vercel@0.12.14
  - @pikku/better-auth@0.12.40
  - @pikku/code-edit@0.12.2
  - @pikku/core@0.12.108
  - @pikku/fetch@0.12.11
  - @pikku/inspector@0.12.76
  - @pikku/knowledge@0.12.13
  - @pikku/kysely@0.13.25
  - @pikku/migrator-sql@0.12.5
  - @pikku/n8n-import@0.0.8
  - @pikku/node-http-server@0.12.15
  - @pikku/openapi-parser@0.12.21
  - @pikku/playwright@0.12.82
  - @pikku/schedule@0.12.8
  - @pikku/skills@0.12.31
  - @pikku/websocket@0.12.5
  - @pikku/ws@0.12.10
...
- b28a8c0: An addon's exposed functions get their own deployment unit
...
- Updated dependencies [b28a8c0]
  - @pikku/inspector@0.12.75
  - @pikku/deploy@0.12.9
  - @pikku/deploy-cloudflare@0.12.17
  - @pikku/core@0.12.107
...
- 0c0689c: db: stop an embedded-postgres boot from failing the command
  ...
  embedded database exited 99 _after_ completing all of its work and printing a
...
- 591593a: Add `pikku knowledge next` — the one thing to do next with the knowledge base, derived
...
- Updated dependencies [591593a]
- Updated dependencies [591593a]
- Updated dependencies [2273c92]
- Updated dependencies [0303b27]
- Updated dependencies [7434e65]
- Updated dependencies [591593a]
- Updated dependencies [f5a8ee4]
  - @pikku/skills@0.12.28
  - @pikku/knowledge@0.12.11
  - @pikku/deploy@0.12.7
...
- 498662a: Measure a finished milestone against its plan, with `pikku knowledge plan progress`.
...
- Updated dependencies [498662a]
- Updated dependencies [e0bf0ce]
...
- Updated dependencies [3d75643]
  ...
  - @pikku/better-auth@0.12.36
  - @pikku/bun-server@0.12.11
  - @pikku/deploy@0.12.4
