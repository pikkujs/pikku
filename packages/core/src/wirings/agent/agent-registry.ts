import type { CoreAgent, AgentRunState } from './agent.types.js'
...
export async function approveAgent(
  ...
  if (!agentRunState) throw new Error('AgentRunStateService not available')
