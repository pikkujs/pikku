...
export const PikkuHTTPProvider: React.FunctionComponent<{ children: React.ReactNode }> = ({ children }) => {
...
export const PikkuRPCProvider: React.FunctionComponent<{ children: React.ReactNode }> = ({ children }) => {
