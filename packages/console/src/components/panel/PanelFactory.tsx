...
} from "../project/panels/FunctionDetailsForm";
import {
...
} from "../project/panels/MiddlewarePanels";
import {
  PermissionConfiguration,
} from "../project/panels/PermissionsPanels";
import {
  AgentConfiguration,
} from "../project/panels/AgentPanels";
import {
  SecretConfiguration,
...
const WorkflowStepTabbedPanel: React.FunctionComponent<{ stepId: string; metadata: any }> = ({
  stepId,
  metadata,
}) => {
  ...
  const isFlowControl = ["branch", "switch", "parallel", "fanout", "filter", "arrayPredicate"].includes(stepType);
  ...
  return (
    <Stack gap="md">
      <Group gap="xs" px="md">
        <GitBranch size={20} />
        <Text size="lg" ff="monospace">{node?.stepName || node?.nodeId || stepId}</Text>
        <PikkuBadge type="label" color="blue">{stepType}</PikkuBadge>
      </Group>
      <Tabs defaultValue={hasRun ? "run" : "overview"} key={hasRun ? "with-run" : "no-run"}>
        <Tabs.List grow>
          <Tabs.Tab value="overview">Overview</Tabs.Tab>
          <Tabs.Tab value="run" disabled={!hasRun}>Run</Tabs.Tab>
        </Tabs.List>
...
const NewWorkflowRunForm: React.FunctionComponent<{ workflowId: string }> = ({
  ...
  const { data: funcMeta, isLoading: funcLoading } = useFunctionMeta(inputFuncId ?? "");
  ...
  const isLoading = (!!inputFuncId && funcLoading) || (!!inputSchemaName && schemaLoading);
      ...
      {startMutation.isError && (
        <Text size="sm" c="red">
          {typeof (startMutation.error as any)?.message === 'string'
            ...
            : JSON.stringify((startMutation.error as any)?.message ?? startMutation.error, null, 2) || "Failed to start workflow"}
        </Text>
      )}
    </Stack>
  );
      ...
      return [
        {
          id: "step",
          title: "Step",
          content: <WorkflowStepTabbedPanel stepId={panelData.id} metadata={panelData.metadata} />,
        },
      ];
    }
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><HttpConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><ChannelConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><RpcConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><SchedulerConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><QueueConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><CliConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><McpConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><TriggerConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><TriggerSourceConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><MiddlewareConfiguration middlewareId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><PermissionConfiguration permissionId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><AgentConfiguration wireId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><SecretConfiguration secretId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
      ...
      return [
        {
          id: "configuration",
          title: "Configuration",
          content: <Box px="md"><VariableConfiguration variableId={panelData.id} metadata={panelData.metadata} /></Box>,
        },
      ];
