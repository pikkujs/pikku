...
import { ChannelDefaultHandlerOf, ChannelHTTPWiringHandlerOf, ChannelsMap } from '${channelsMapPath}';
...
class PikkuWebSocketRoute<Channel extends keyof ChannelsMap, Route extends keyof ChannelsMap[Channel]['routes']> extends CorePikkuRouteHandler {
    public subscribe<
        ...
        Data extends ChannelHTTPWiringHandlerOf<Channel, Route, Method>['output']
    ...
    public send<
        Method extends keyof ChannelsMap[Channel]['routes'][Route],
        Data extends ChannelHTTPWiringHandlerOf<Channel, Route, Method>['input']
