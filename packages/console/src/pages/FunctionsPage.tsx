...
export const FunctionsPage: React.FunctionComponent = () => {
  ...
  return (
    <PanelProvider>
      <ResizablePanelLayout header={<DetailPageHeader icon={FunctionSquare} category="Functions" docsHref="https://pikkujs.com/docs/functions" />} showTabs={false} hidePanel={functions.length === 0} emptyPanelMessage="Select a function to view its details">
