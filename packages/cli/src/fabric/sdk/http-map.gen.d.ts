...
export type GetSlackInstallUrlInput = void | undefined
export type GetSlackInstallUrlOutput = {
  installUrl: string
}
...
export type HandleSlackCommandInput = any
export type HandleSlackCommandOutput = any
...
export type SecretSchema_slackApp = {
  /** Slack app client ID */
  clientId: string
...
export type SlackOAuthCallbackInput = {
  code: string
}
export type SlackOAuthCallbackOutput = {
  success: boolean
...
export type VariableSchema_slackAppBaseUrl = string
...
export type GraphStarterInputBody = Omit<
  ...
  'workflowName' | 'nodeId'
> & {}
export type GetSlackInstallUrlInputBody = GetSlackInstallUrlInput & {}
export type SlackOAuthCallbackInputBody = SlackOAuthCallbackInput & {}
export type HandleSlackCommandInputBody = HandleSlackCommandInput & {}
...
export type IngestTelemetryInputBody = IngestTelemetryInput & {}
...
export type HTTPWiringsMap = {
  ...
  readonly '/api/slack/install-url': {
    readonly GET: HTTPWiringHandler<
      GetSlackInstallUrlInput,
      GetSlackInstallUrlOutput
    >
  }
  readonly '/api/slack/oauth/callback': {
    readonly GET: HTTPWiringHandler<
      SlackOAuthCallbackInput,
      SlackOAuthCallbackOutput
    >
  }
  readonly '/auth/csrf': {
  ...
  readonly '/api/slack/commands': {
    readonly POST: HTTPWiringHandler<
      HandleSlackCommandInput,
      HandleSlackCommandOutput
    >
  }
  ...
  readonly '/_internal/telemetry': {
    readonly POST: HTTPWiringHandler<
      IngestTelemetryInput,
      IngestTelemetryOutput
    >
  }
  readonly '/tenant/enqueue': {
    readonly POST: HTTPWiringHandler<
      EnqueueTenantJobInput,
      EnqueueTenantJobOutput
    >
  }
