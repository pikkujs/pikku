...
import type {
  WorkflowRun,
  WorkflowRunStatus,
} from '.bun/@pikku+core@0.12.106/node_modules/@pikku/core/dist/wirings/workflow/workflow.types'
import type {
  StreamWorkflowRunInput,
  GetScenarioArtifactInput,
} from '.bun/@pikku+addon-console@0.12.52+2ba48ff24cda2800/node_modules/@pikku/addon-console/dist/.pikku/addon/rpc/pikku-rpc-wirings-map.internal.gen'
import type {
  ListPackagesInput,
  SearchPackagesInput,
  GetPackageInput,
  ...
  ListOpenApisInput,
  GetOpenApiInput,
  GetPackageDownloadInput,
  RequestPublishUrlInput,
  PublishPackageInput,
  IngestPackageInput,
  StartMetaExtractionInput,
  StartOpenApiEnrichmentInput,
} from '../../../addon-registry/.pikku/addon/rpc/pikku-rpc-wirings-map.internal.gen.d.js'
import type {
  GetReviewQueueInput,
  GetReviewFixesInput,
  CastVerdictInput,
  ClearVerdictInput,
} from '../../../addon-review/.pikku/addon/rpc/pikku-rpc-wirings-map.internal.gen.d.js'
...
export type AgentStreamCallerInputParams = Pick<
  AgentStreamCallerInput,
  'agentName'
> & {}
export type AgentStreamCallerInputBody = Omit<
  AgentStreamCallerInput,
  'agentName'
> & {}
export type AgentApproveCallerInputParams = Pick<
  AgentApproveCallerInput,
  'agentName'
> & {}
export type AgentApproveCallerInputBody = Omit<
  AgentApproveCallerInput,
  'agentName'
> & {}
export type AgentResumeCallerInputParams = Pick<
  AgentResumeCallerInput,
  'agentName'
> & {}
export type AgentResumeCallerInputBody = Omit<
  AgentResumeCallerInput,
  'agentName'
> & {}
...
export type StreamWorkflowRunInputBody = Omit<
  ...
  'runId'
> & {}
export type GetScenarioArtifactInputParams = Pick<
  GetScenarioArtifactInput,
  'runId'
> & {}
export type GetScenarioArtifactInputBody = Omit<
  GetScenarioArtifactInput,
  'runId'
> & {}
export type RealtimeEventStreamInputParams = Pick<
  RealtimeEventStreamInput,
  'topic'
> & {}
export type RealtimeEventStreamInputBody = Omit<
  RealtimeEventStreamInput,
  'topic'
> & {}
...
export type WorkflowStarterInputBody = Omit<
  ...
  'workflowName'
> & {}
export type WorkflowApproverInputParams = Pick<
  WorkflowApproverInput,
  'workflowName' | 'runId'
> & {}
export type WorkflowApproverInputBody = Omit<
  WorkflowApproverInput,
  'workflowName' | 'runId'
> & {}
...
export type GetDeployArtifactUploadUrlInputBody =
...
export type RecordImageBuildFinishedInputBody =
  RecordImageBuildFinishedInput & {}
export type RecordDeployWebhookResultInputBody =
  RecordDeployWebhookResultInput & {}
export type ReadCascadeDefinitionInputBody = ReadCascadeDefinitionInput & {}
export type RunStuckProjectWatchdogDiagnosticInputBody =
  RunStuckProjectWatchdogDiagnosticInput & {}
export type RunAnalyticsRollupDiagnosticInputBody =
  RunAnalyticsRollupDiagnosticInput & {}
export type StartGitProviderLinkingInputBody = StartGitProviderLinkingInput & {}
export type CompleteGitProviderLinkingInputBody =
  CompleteGitProviderLinkingInput & {}
export type ListLinkedGitAccountsInputBody = ListLinkedGitAccountsInput & {}
export type UnlinkGitProviderAccountInputParams = Pick<
  UnlinkGitProviderAccountInput,
  'provider'
> & {}
export type UnlinkGitProviderAccountInputBody = Omit<
  UnlinkGitProviderAccountInput,
  'provider'
> & {}
...
export type GetPackageDownloadInputParams = Pick<
  GetPackageDownloadInput,
  'id'
> & {}
export type GetPackageDownloadInputBody = Omit<
  GetPackageDownloadInput,
  'id'
> & {}
...
export type GetScenarioRunArtifactInputParams = Pick<
  GetScenarioRunArtifactInput,
  'stageId' | 'runId'
> & {}
export type GetScenarioRunArtifactInputBody = Omit<
  GetScenarioRunArtifactInput,
  'stageId' | 'runId'
> & {}
...
export type AddTicketCommentInputParams = Pick<
  AddTicketCommentInput,
  'ticketId'
> & {}
export type AddTicketCommentInputBody = Omit<
  AddTicketCommentInput,
  'ticketId'
> & {}
export type AttachTicketSpecInputParams = Pick<
  AttachTicketSpecInput,
  'ticketId'
> & {}
export type AttachTicketSpecInputBody = Omit<
  AttachTicketSpecInput,
  'ticketId'
> & {}
export type RecordTicketReviewFinishedInputBody =
  RecordTicketReviewFinishedInput & {}
export type RecordTicketBuildFinishedInputBody =
...
export type HTTPWiringsMap = {
  ...
  readonly '/scenario-run/:runId/artifact': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['console:getScenarioArtifact']['input'],
      FlattenedRPCMap['console:getScenarioArtifact']['output']
    >
  }
  ...
  readonly '/auth/github/user/callback': {
    readonly GET: HTTPWiringHandler<
      GithubUserLinkCallbackInput,
      GithubUserLinkCallbackOutput
    >
  }
  ...
  readonly '/registry/addons': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:listPackages']['input'],
      FlattenedRPCMap['registry:listPackages']['output']
    >
  }
  readonly '/registry/addons/search': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:searchPackages']['input'],
      FlattenedRPCMap['registry:searchPackages']['output']
    >
  }
  readonly '/registry/addons/categories': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:listPackageCategories']['input'],
      FlattenedRPCMap['registry:listPackageCategories']['output']
    >
  }
  readonly '/registry/addons/:id': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:getPackage']['input'],
      FlattenedRPCMap['registry:getPackage']['output']
    >
  }
  readonly '/registry/addons/:id/icon': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:getPackageIcon']['input'],
      FlattenedRPCMap['registry:getPackageIcon']['output']
    >
  }
  readonly '/registry/openapis/providers': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:listOpenApiProviders']['input'],
      FlattenedRPCMap['registry:listOpenApiProviders']['output']
    >
  }
  readonly '/registry/openapis/categories': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:listOpenApiCategories']['input'],
      FlattenedRPCMap['registry:listOpenApiCategories']['output']
    >
  }
  readonly '/registry/openapis/sync/status': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:getSyncStatus']['input'],
      FlattenedRPCMap['registry:getSyncStatus']['output']
    >
  }
  readonly '/registry/openapis': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:listOpenApis']['input'],
      FlattenedRPCMap['registry:listOpenApis']['output']
    >
  }
  readonly '/registry/openapis/:name': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:getOpenApi']['input'],
      FlattenedRPCMap['registry:getOpenApi']['output']
    >
  }
  readonly '/registry/addons/:id/download': {
    readonly GET: HTTPWiringHandler<
      FlattenedRPCMap['registry:getPackageDownload']['input'],
      FlattenedRPCMap['registry:getPackageDownload']['output']
    >
  }
  ...
  readonly '/platform/container-logs': {
    readonly POST: HTTPWiringHandler<
      IngestContainerLogsInput,
      IngestContainerLogsOutput
    >
  }
  ...
  readonly '/deploy/meta': {
    readonly POST: HTTPWiringHandler<
      UploadDeployMetaInput,
      UploadDeployMetaOutput
    >
  }
  readonly '/deploy/security-gate': {
    readonly POST: HTTPWiringHandler<
      EvaluateSecurityGateInput,
      EvaluateSecurityGateOutput
    >
  }
  readonly '/deploy/build-finished': {
    readonly POST: HTTPWiringHandler<
      RecordBuildFinishedInput,
      RecordBuildFinishedOutput
    >
  }
  readonly '/deploy/image-build-finished': {
    readonly POST: HTTPWiringHandler<
      RecordImageBuildFinishedInput,
      RecordImageBuildFinishedOutput
    >
  }
  readonly '/deploy/webhook-result': {
    readonly POST: HTTPWiringHandler<
      RecordDeployWebhookResultInput,
      RecordDeployWebhookResultOutput
    >
  }
  readonly '/e2e/diagnostics/cascade-definition': {
    readonly POST: HTTPWiringHandler<
      ReadCascadeDefinitionInput,
      ReadCascadeDefinitionOutput
    >
  }
  readonly '/e2e/diagnostics/run-stuck-project-watchdog': {
    readonly POST: HTTPWiringHandler<
      RunStuckProjectWatchdogDiagnosticInput,
      RunStuckProjectWatchdogDiagnosticOutput
    >
  }
  readonly '/e2e/diagnostics/run-analytics-rollup': {
    readonly POST: HTTPWiringHandler<
      RunAnalyticsRollupDiagnosticInput,
      RunAnalyticsRollupDiagnosticOutput
    >
  }
  ...
  readonly '/platform/changes/file': {
    readonly POST: HTTPWiringHandler<
      IngestStageChangeInput,
      IngestStageChangeOutput
    >
  }
  readonly '/platform/changes/list': {
    readonly POST: HTTPWiringHandler<
      ListStageChangesInput,
      ListStageChangesOutput
    >
  }
  readonly '/platform/changes/answer': {
    readonly POST: HTTPWiringHandler<
      AnswerStageChangeInput,
      AnswerStageChangeOutput
    >
  }
  readonly '/platform/changes/shot': {
    readonly POST: HTTPWiringHandler<
      UploadStageShotInput,
      UploadStageShotOutput
    >
  }
  readonly '/registry/addons/publish-url': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['registry:requestPublishUrl']['input'],
      FlattenedRPCMap['registry:requestPublishUrl']['output']
    >
  }
  readonly '/registry/addons/publish': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['registry:publishPackage']['input'],
      FlattenedRPCMap['registry:publishPackage']['output']
    >
  }
  readonly '/registry/addons/ingest': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['registry:ingestPackage']['input'],
      FlattenedRPCMap['registry:ingestPackage']['output']
    >
  }
  readonly '/registry/openapis/sync': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['registry:syncOpenApisHttp']['input'],
      FlattenedRPCMap['registry:syncOpenApisHttp']['output']
    >
  }
  readonly '/registry/openapis/extract-meta': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['registry:startMetaExtraction']['input'],
      FlattenedRPCMap['registry:startMetaExtraction']['output']
    >
  }
  readonly '/registry/openapis/enrich': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['registry:startOpenApiEnrichment']['input'],
      FlattenedRPCMap['registry:startOpenApiEnrichment']['output']
    >
  }
  readonly '/review/queue': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['review:getReviewQueue']['input'],
      FlattenedRPCMap['review:getReviewQueue']['output']
    >
  }
  readonly '/review/fixes': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['review:getReviewFixes']['input'],
      FlattenedRPCMap['review:getReviewFixes']['output']
    >
  }
  readonly '/review/verdict': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['review:castVerdict']['input'],
      FlattenedRPCMap['review:castVerdict']['output']
    >
  }
  readonly '/review/verdict/clear': {
    readonly POST: HTTPWiringHandler<
      FlattenedRPCMap['review:clearVerdict']['input'],
      FlattenedRPCMap['review:clearVerdict']['output']
    >
  }
  ...
  readonly '/v1/stages/telemetry': {
    readonly POST: HTTPWiringHandler<
      IngestStageTelemetryInput,
      IngestStageTelemetryOutput
    >
  }
  ...
  readonly '/webhooks/github': {
    readonly POST: HTTPWiringHandler<
      GithubPushWebhookInput,
      GithubPushWebhookOutput
    >
  }
  readonly '/webhooks/r2-content': {
    readonly POST: HTTPWiringHandler<
      R2ContentWebhookInput,
      R2ContentWebhookOutput
    >
  }
  readonly '/webhooks/ai-usage': {
    readonly POST: HTTPWiringHandler<
      RecordAIUsageEventInput,
      RecordAIUsageEventOutput
    >
  }
  readonly '/webhooks/runtime-release': {
    readonly POST: HTTPWiringHandler<
      PublishRuntimeReleaseInput,
      PublishRuntimeReleaseOutput
    >
  }
  readonly '/webhooks/deploy-backend': {
    readonly POST: HTTPWiringHandler<
      TriggerBackendDeployInput,
      TriggerBackendDeployOutput
    >
  }
  readonly '/git/accounts/:provider': {
    readonly DELETE: HTTPWiringHandler<
      UnlinkGitProviderAccountInput,
      UnlinkGitProviderAccountOutput
    >
  }
  readonly '/deploy/status': {
    readonly PATCH: HTTPWiringHandler<
      ReportDeployProgressInput,
      ReportDeployProgressOutput
    >
  }
}
