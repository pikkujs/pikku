...
export const FunctionLink: React.FunctionComponent<{ pikkuFuncId?: string; label?: string }> = ({ pikkuFuncId, label }) => {
    ...
    <Box>
      ...
      <Group gap={6}>
        <PikkuBadge
          ...
          onClick={() => navigateInPanel("function", pikkuFuncId, displayName, funcMeta)}
        >
          {displayName}
        </PikkuBadge>
      </Group>
