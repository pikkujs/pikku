...
const VariablesTable: React.FunctionComponent<{ items: VariableItem[]; loading?: boolean }> = ({ items, loading }) => {
  ...
  const columns = useMemo(() => [
    ...
    },
    {
      ...
      render: (item: VariableItem) => (
        <Text size="xs" c="dimmed" ff="monospace">{item.variableId}</Text>
      ),
    },
  ], []);
...
const VariablesPageContent: React.FunctionComponent = () => {
  ...
  return (
    <ResizablePanelLayout
      header={<DetailPageHeader icon={Variable} category="Variables" docsHref="https://pikkujs.com/docs/variables" />}
    >
