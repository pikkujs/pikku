...
import ReactFlow, { useNodesState, useEdgesState, NodeTypes, EdgeTypes, Background, BackgroundVariant, useReactFlow, ReactFlowProvider } from "reactflow";
  ...
  return (
    ...
    >
      <Box style={{ height: "100%", position: "relative" }}>
        <ReactFlowProvider>
          <ChannelCanvasFlow channelName={channelName} channelMeta={channelMeta} />
        </ReactFlowProvider>
      </Box>
    </ResizablePanelLayout>
  );
