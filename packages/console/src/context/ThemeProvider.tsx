...
const cssVariablesResolver: CSSVariablesResolver = () => ({
  ...
  dark: {
    ...
    '--mantine-color-default-border': 'rgba(255,255,255,0.10)',
    ...
    '--app-row-border': 'rgba(255,255,255,0.09)',
    ...
    '--app-tag-border': 'rgba(6,182,212,0.28)',
    '--app-tag-color': '#22d3ee',
    '--app-service-bg': 'rgba(124,58,237,0.14)',
    '--app-service-border': 'rgba(124,58,237,0.32)',
    '--app-service-color': '#a78bfa',
    '--app-blue': '#60a5fa',
    '--app-blue-border': 'rgba(96,165,250,0.30)',
    '--app-blue-hover': 'rgba(96,165,250,0.10)',
    '--app-green': '#4ade80',
    '--app-green-border': 'rgba(74,222,128,0.30)',
    '--app-red': '#f87171',
    '--app-red-border': 'rgba(248,113,113,0.30)',
    '--app-amber': '#fbbf24',
    '--app-amber-border': 'rgba(251,191,36,0.30)',
  ...
  light: {
    ...
    '--mantine-color-default-border': 'rgba(0,0,0,0.12)',
    ...
    '--app-row-border': 'rgba(0,0,0,0.08)',
    ...
    '--app-tag-border': 'rgba(6,182,212,0.20)',
    '--app-tag-color': '#0891b2',
    '--app-service-bg': 'rgba(124,58,237,0.08)',
    '--app-service-border': 'rgba(124,58,237,0.20)',
    '--app-service-color': '#7c3aed',
    '--app-blue': '#2563eb',
    '--app-blue-border': 'rgba(37,99,235,0.30)',
    '--app-blue-hover': 'rgba(37,99,235,0.08)',
    '--app-green': '#16a34a',
    '--app-green-border': 'rgba(22,163,74,0.30)',
    '--app-red': '#dc2626',
    '--app-red-border': 'rgba(220,38,38,0.30)',
    '--app-amber': '#d97706',
    '--app-amber-border': 'rgba(217,119,6,0.30)',
